...
%In a traditional ER workflow, pairs of records are heuristically matched with some measure of similarity (eg. Jaccard similarity for string-valued attributes).
...
Firstly, it allows us to first take a broader view of entity resolution.
