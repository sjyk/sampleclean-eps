...
\title{Theoretical Analysis of Alternative Representations of Entity Resolution Pipelines}
...
\input{proposal.tex}
\input{sampling.tex}
%\input{efficient_execution.tex}
\input{streaming_progressive_clustering.tex}
\input{results.tex}
